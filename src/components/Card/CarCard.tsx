        ...
        <div className="flex flex-col justify-between w-full">
          ...
          <div className="flex flex-col sm:flex-row justify-between w-full mt-6 gap-4">
            ...
            <div className="flex justify-center items-end">
              ...
              >
                <button className="animated-button relative flex items-center gap-1 py-1 px-9 border-[1px] border-primary/20 text-base font-semibold rounded-full transition-all duration-[600ms] ease-[cubic-bezier(0.23,1,0.32,1)] overflow-hidden cursor-pointer hover:bg-background/10">
                  <svg
